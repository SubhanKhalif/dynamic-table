document.addEventListener("DOMContentLoaded", function () {
    ...
    function initializeSpreadsheet() {
        const savedData = JSON.parse(localStorage.getItem("ptrc")) || [[]];
        const cellLockStates = JSON.parse(localStorage.getItem("cellLockStates")) || {};
    ...
    function undo() {
        if (undoStack.length > 1) {
            ...
            localStorage.setItem("ptrc", JSON.stringify(previousState.data));
    ...
    function redo() {
        if (redoStack.length > 0) {
            ...
            localStorage.setItem("ptrc", JSON.stringify(nextState.data));
    ...
    function saveData() {
        ...
        localStorage.setItem("ptrc", JSON.stringify(data));
