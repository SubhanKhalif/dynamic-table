document.addEventListener("DOMContentLoaded", function () {
    ...
    function initializeSpreadsheet() {
        const savedData = JSON.parse(localStorage.getItem("zp")) || [[]];
        const cellLockStates = JSON.parse(localStorage.getItem("cellLockStates")) || {};
    ...
    function redo() {
        if (redoStack.length > 0) {
            ...
            localStorage.setItem("zp", JSON.stringify(nextState.data));
    ...
    function saveData() {
        ...
        localStorage.setItem("zp", JSON.stringify(data));
