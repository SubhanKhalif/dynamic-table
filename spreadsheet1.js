document.addEventListener("DOMContentLoaded", function () {
    ...
    function saveState() {
        ...
        const state = {
            ...
            cellLockStates: sessionStorage.getItem("cellLockStates") ? JSON.parse(sessionStorage.getItem("cellLockStates")) : {}
        };
            ...
            cells.forEach((cellData, colIndex) => {
                ...
                if (currentCell) {
                    ...
                    if (cellData.trim() !== '') {
                        ...
                        const cellLockStates = sessionStorage.getItem("cellLockStates") ? JSON.parse(sessionStorage.getItem("cellLockStates")) : {};
                        cellLockStates[cellKey] = true;
                        sessionStorage.setItem("cellLockStates", JSON.stringify(cellLockStates));
                    }
                }
            });
        });
    ...
    function initializeSpreadsheet() {
        const savedData = sessionStorage.getItem("spreadsheetData") ? JSON.parse(sessionStorage.getItem("spreadsheetData")) : [[]];
        const cellLockStates = sessionStorage.getItem("cellLockStates") ? JSON.parse(sessionStorage.getItem("cellLockStates")) : {};
        const savedHeaders = sessionStorage.getItem("columnHeaders") ? JSON.parse(sessionStorage.getItem("columnHeaders")) : [];
    ...
    function undo() {
        if (undoStack.length > 1) {
            ...
            sessionStorage.setItem("spreadsheetData", JSON.stringify(previousState.data));
            sessionStorage.setItem("columnHeaders", JSON.stringify(previousState.headers));
            sessionStorage.setItem("cellLockStates", JSON.stringify(previousState.cellLockStates));
    ...
    function redo() {
        if (redoStack.length > 0) {
            ...
            sessionStorage.setItem("spreadsheetData", JSON.stringify(nextState.data));
            sessionStorage.setItem("columnHeaders", JSON.stringify(nextState.headers));
            sessionStorage.setItem("cellLockStates", JSON.stringify(nextState.cellLockStates));
        ...
        for (let i = 0; i < colCount; i++) {
            ...
            th.addEventListener('input', () => {
                ...
                const headers = Array.from(headerRow2.children)
                    .slice(1)
                    .map(header => header.textContent);
                sessionStorage.setItem("columnHeaders", JSON.stringify(headers));
            });
    ...
    function saveData() {
        ...
        sessionStorage.setItem("spreadsheetData", JSON.stringify(data));
