document.addEventListener("DOMContentLoaded", function () {
    ...
    function initializeSpreadsheet() {
        const savedData = JSON.parse(localStorage.getItem("PWD")) || [[]];
        const cellLockStates = JSON.parse(localStorage.getItem("cellLockStates")) || {};
    ...
    function undo() {
        if (undoStack.length > 1) {
            ...
            localStorage.setItem("PWD", JSON.stringify(previousState.data));
    ...
    function redo() {
        if (redoStack.length > 0) {
            ...
            localStorage.setItem("PWD", JSON.stringify(nextState.data));
    ...
    function saveData() {
        ...
        localStorage.setItem("PWD", JSON.stringify(data));
