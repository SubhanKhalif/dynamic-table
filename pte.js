document.addEventListener("DOMContentLoaded", function () {
    ...
    function initializeSpreadsheet() {
        const savedData = JSON.parse(localStorage.getItem("pte")) || [[]];
        const cellLockStates = JSON.parse(localStorage.getItem("cellLockStates")) || {};
    ...
    function undo() {
        if (undoStack.length > 1) {
            ...
            localStorage.setItem("pte", JSON.stringify(previousState.data));
    ...
    function redo() {
        if (redoStack.length > 0) {
            ...
            localStorage.setItem("pte", JSON.stringify(nextState.data));
    ...
    function saveData() {
        ...
        localStorage.setItem("pte", JSON.stringify(data));
