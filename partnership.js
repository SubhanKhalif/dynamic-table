document.addEventListener("DOMContentLoaded", function () {
    ...
    function initializeSpreadsheet() {
        const savedData = JSON.parse(localStorage.getItem("partnership")) || [[]];
        const cellLockStates = JSON.parse(localStorage.getItem("cellLockStates")) || {};
    ...
    function undo() {
        if (undoStack.length > 1) {
            ...
            localStorage.setItem("partnership", JSON.stringify(previousState.data));
    ...
    function redo() {
        if (redoStack.length > 0) {
            ...
            localStorage.setItem("partnership", JSON.stringify(nextState.data));
    ...
    function saveData() {
        ...
        localStorage.setItem("partnership", JSON.stringify(data));
